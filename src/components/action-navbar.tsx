    ...
    <div className="fixed right-[max(var(--safe-right),0.5rem)] bottom-[max(var(--safe-bottom),0.5rem)]">
      <div className="flex gap-1 rounded-lg border bg-slate-dark p-0.5 backdrop-blur">
        <button
          ...
          className="flex items-center justify-center gap-2 rounded-md px-3 py-2 min-h-11 text-ivory-light transition-transform duration-100 ease-in-out active:scale-95"
        >
          <LightningIcon
            className="size-5"
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 rounded-md px-3 py-2 text-ivory-light transition-transform duration-100 ease-in-out active:scale-95"
        >
